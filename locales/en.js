...
export default {
	...
	"settings:avgTimeInContentDescription": "The Average Time in Content indicator shows the average time spent in content, as an average of total time per course, for the user across all the courses included in the applied filters.  The metric is reported in minutes.",
	...
	"settings:lastAccessedSystemDescription": "The System Last Access indicator displays the timestamp of the last time the user accessed the system in any way.",
};
