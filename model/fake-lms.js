...
export async function fetchData({ roleIds, semesterIds, orgUnitIds, defaultView = false }) {
	const demoData = {
		records: [
			...
			[2, 200, 700, 1, 38, 4000, null, 0, 0, 0, null],
			[1, 200, 700, 1, 71, 4000, null, 0, 0, 0, 0.8],
