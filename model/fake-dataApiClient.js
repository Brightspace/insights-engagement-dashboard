...
export async function fetchData({ roleIds, semesterIds, orgUnitIds, defaultView = false }) {
	const demoData = {
		...
		users: [ // some of which are out of order
			[100,  'ATest', 'AStudent', 'AStudent', 1601193037132, 700],
			[300,  'CTest', 'CStudent', 'CStudent', 1603193037132, null],
			[200,  'BTest', 'BStudent', 'BStudent', 1607528565300, null],
			[400,  'DTest', 'DStudent', 'DStudent', null, null],
			[500,  'ETest', 'EStudent', 'EStudent', 1546318800000, null],
