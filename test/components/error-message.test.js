...
describe('d2l-insights-error-message', () => {

	describe('constructor', () => {
		it('should construct', () => {
			runConstructor('d2l-insights-error-message');
		});
	});
	...
	describe('default message', () => {
		...
		before(async() => {
			el = await fixture(html`
				<d2l-insights-error-message type="default" text="some text"></d2l-insights-error-message>
			`);
		});
	...
	describe('message with button', () => {
		...
		before(async() => {
			el = await fixture(html`
				<d2l-insights-error-message type="button" text="some text" button-text="button text"></d2l-insights-error-message>
			`);
		});
		...
		it('should fire an event when clicked', async() => {
			const listener = oneEvent(el, 'd2l-insights-error-message-button-click');
			const button = el.shadowRoot.querySelector('d2l-button');
			button.click();
			await listener;
		});
	...
	describe('message with link', () => {
		...
		before(async() => {
			el = await fixture(html`
				<d2l-insights-error-message type="link" text="some text" href="https://www.example.com" link-text="link text"></d2l-insights-error-message>
			`);
		});
